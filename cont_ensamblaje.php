        ...
        <div class="panel panel-success setup-content" id="step-1">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <input maxlength="100" type="number" required="required" class="form-control" placeholder="Enter First Name" />
                </div>
        ...
        <div class="panel panel-success setup-content" id="step-2">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <input maxlength="200" type="number" required="required" class="form-control" placeholder="Enter Company Name" />
                </div>
                <div class="form-group">
                    <label class="control-label">WIFI BT GPS ANT FPC BLACK</label>
                    <input maxlength="200" type="number" required="required" class="form-control" placeholder="Enter Company Address" />
                </div>
                <button class="btn btn-success nextBtn pull-right" type="button">Next</button>
            </div>
        </div>
