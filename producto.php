          ...
          <div class="panel-body">
            <div class="row">
              <div class="col-sm-4 col-sm-offset-2 text-center">
				 <img class="item-img img-responsive" src="img/stockie.png" alt=""> 
				  <br>
					...
					<a href="#myModal2" data-toggle="modal" data-proveedor='<?php echo $row['numero_proveedor'];?>' data-codigo='<?php echo $row['codigo_producto'];?>' data-nombre='<?php echo $row['nombre_producto'];?>' data-color='<?php echo $row['color_producto'];?>' data-categoria='<?php echo $row['id_categoria']?>' data-precio='<?php echo $row['precio_producto']?>' data-stock='<?php echo $row['stock'];?>' data-id='<?php echo $row['id_producto'];?>' class="btn btn-info" title="Editar"> <i class="glyphicon glyphicon-pencil"></i> Editar </a>	
              ...
              <div class="col-sm-6 text-left">
                <div class="row margin-btm-20">
                	<div class="col-sm-12">
                      <span class="current-stock">NUMERO DE PARTE PROVEEDOR:</span>
                    </div>
					<div class="col-sm-12 margin-btm-10">
                      <span class="item-quantity"> <?php echo $row['numero_proveedor'];?></span>
                    </div>
                    <div class="col-sm-12">
                      <span class="current-stock">CODIGO SAP (LANIX):</span>
                    </div>
					<div class="col-sm-12 margin-btm-10">
                      <span class="item-quantity"> <?php echo $row['codigo_producto'];?></span>
                    </div>
                    <div class="col-sm-12">
                      <span class="current-stock">DESCRIPTION:</span>
                    </div>
					<div class="col-sm-12 margin-btm-10">
                    ...
                    <div class="col-sm-12">
                      <span class="current-stock">COLOR:</span>
                    </div>
					<div class="col-sm-12 margin-btm-10">
                      <span class="item-quantity"> <?php echo $row['color_producto'];?></span>
                    </div>
                     <div class="col-sm-12">
                      <span class="current-stock">UNIT PRICE
(USD):</span>
                    </div>
					<div class="col-sm-12 margin-btm-10">
					...
					<div class="col-sm-12">
                      <span class="current-stock">MATERIAL DISPONIBLE:</span>
                    </div>
                    <div class="col-sm-12 margin-btm-10">
