<?php
	...
	if (empty($_POST['mod_id'])) {
		...
		$sql="UPDATE products SET numero_proveedor='".$proveedor."', codigo_producto='".$codigo."', nombre_producto='".$nombre."', color_producto='".$color."', id_categoria='".$categoria."', precio_producto='".$precio_venta."', stock='".$stock."' WHERE id_producto='".$id_producto."'";
