...
include('is_logged.php');//Archivo verifica que el usario que intenta acceder a la URL esta logueado
	...
	if (empty($_POST['codigo'])) {
           $errors[] = "Código vacío";
			...
			$errors[] = "Número de proveedor del producto vacío";
        } else if (empty($_POST['nombre'])){
			$errors[] = "Nombre del producto vacío";
		} else if (empty($_POST['color'])){
			$errors[] = "color del producto vacío";
		} else if ($_POST['stock']==""){
		...
		$sql="INSERT INTO products (numero_proveedor, codigo_producto, nombre_producto, color_producto, date_added, precio_producto, stock, id_categoria) VALUES ('$proveedor','$codigo','$nombre','$color','$date_added','$precio_venta', '$stock','$id_categoria')";
