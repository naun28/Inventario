		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			...
			<div class="form-group">
				<label for="mod_proveedor" class="col-sm-3 control-label">NÚMERO DE PARTE PROVEEDOR</label>
				<div class="col-sm-8">
				  <textarea class="form-control" id="mod_proveedor" name="mod_proveedor" placeholder="Número de proveedor" required></textarea>
				</div>
			  </div>
			  <div class="form-group">
				<label for="mod_codigo" class="col-sm-3 control-label">CÓDIGO SAP (LANIX)</label>
				<div class="col-sm-8">
			   ...
			   <div class="form-group">
				<label for="mod_nombre" class="col-sm-3 control-label">DESCRIPTION</label>
				<div class="col-sm-8">
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-8">
				  <textarea class="form-control" id="mod_color" name="mod_color" placeholder="Color del producto" required></textarea>
				</div>
			  </div>
			  
			  <div class="form-group">
				<label for="mod_categoria" class="col-sm-3 control-label">ClASIFICACIÓN</label>
				<div class="col-sm-8">
			  ...
			  <!-- <div class="form-group">
				<label for="mod_precio" class="col-sm-3 control-label">UNIT PRICE
(USD)</label>
				<div class="col-sm-8">
			 ...
			 <div class="form-group">
				<label for="mod_stock" class="col-sm-3 control-label">CANTIDAD POR EQUIPO</label>
				<div class="col-sm-8">
